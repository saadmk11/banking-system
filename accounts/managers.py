...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, account_no, password, **extra_fields):
        """
    ...
    def create_user(self, account_no, password=None, **extra_fields):
        ...
        return self._create_user(account_no, password, **extra_fields)

    def create_superuser(self, account_no, password, **extra_fields):
